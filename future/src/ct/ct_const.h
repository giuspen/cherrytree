...
const constexpr std::array<const gchar*, 1> SPECIAL_CHAR_REGISTERED_TRADEMARK =  {"®"};
const constexpr std::array<const gchar*, 3> SELWORD_CHARS_DEFAULT {".", "-", "@"};
const constexpr std::array<const gchar*, 5> CHARS_LISTBUL_DEFAULT {"•", "◇", "▪", "-→", "⇒"};
const constexpr std::array<const gchar*, 4> CHARS_TOC_DEFAULT {"▸", "•", "◇", "▪"};
const constexpr std::array<const gchar*, 3> CHARS_TODO_DEFAULT    {"☐", "☑", "☒"};
const constexpr std::array<const gchar*, 2> CHARS_SMART_DQUOTE_DEFAULT    {"“", "”"};
const constexpr std::array<const gchar*, 2> CHARS_SMART_SQUOTE_DEFAULT    {"‘", "’"};
