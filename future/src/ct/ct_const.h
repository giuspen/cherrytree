...
extern const gchar    CHAR_TAB[];
extern const gchar    CHARS_LISTNUM[];
extern const int      NUM_CHARS_LISTNUM;
extern const gchar    CHAR_TILDE[];
extern const gchar    CHAR_MINUS[];
extern const gchar    CHAR_DQUOTE[];
extern const gchar    CHAR_SMART_DQUOTE_0[];
extern const gchar    CHAR_SMART_DQUOTE_1[];
extern const gchar    CHAR_SQUOTE[];
extern const gchar    CHAR_SMART_SQUOTE_0[];
extern const gchar    CHAR_SMART_SQUOTE_1[];
extern const gchar    CHAR_GRAVE[];
extern const gchar    CHAR_SLASH[];
extern const gchar    CHAR_BSLASH[];
extern const gchar    CHAR_SQ_BR_OPEN[];
extern const gchar    CHAR_SQ_BR_CLOSE[];
extern const gchar    CHAR_PARENTH_OPEN[];
extern const gchar    CHAR_PARENTH_CLOSE[];
extern const gchar    CHAR_LESSER[];
extern const gchar    CHAR_GREATER[];
extern const gchar    CHAR_STAR[];
extern const gchar    CHAR_QUESTION[];
extern const gchar    CHAR_COMMA[];
extern const gchar    CHAR_COLON[];
extern const gchar    CHAR_SEMICOLON[];
extern const gchar    CHAR_USCORE[];
extern const gchar    CHAR_EQUAL[];
extern const gchar    CHAR_BR_OPEN[];
extern const gchar    CHAR_BR_CLOSE[];
extern const gchar    CHAR_CARET[];
extern const gchar    CHAR_PIPE[];
extern const gchar    CHAR_AMPERSAND[];
