...
'idialog':True}
    ...
    def dialog_search(self, title, replace_on, multiple_nodes, pattern_required):
        ...
        bw_radiobutton = Gtk.RadioButton.new_with_label_from_widget(fw_radiobutton, _("Backward"))
        ...
        first_from_radiobutton = Gtk.RadioButton.new_with_label_from_widget(all_radiobutton, _("First From Selection"))
        first_from_radiobutton.set_active(self.search_replace_dict['a_ff_fa'] == 1)
        first_all_radiobutton = Gtk.RadioButton.new_with_label_from_widget(all_radiobutton, _("First in All Range"))
