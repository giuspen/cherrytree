...
def get_entries(dad):
    ...
    ( "NewInstance", "new-instance", _("New _Instance"), None, _("Start a New Instance of CherryTree"), dad.file_new),
    ( "OpenFile", "gtk-open", _("_Open File"), "<control>O", _("Open a CherryTree Document"), dad.file_open),
    ( "Save", "gtk-save", _("_Save"), "<control>S", _("Save File"), dad.file_save),
    ( "SaveAs", "gtk-save-as", _("Save _As"), "<control><shift>S", _("Save File As"), dad.file_save_as),
    ( "OpenCfgFolder", "gtk-directory", _("Open Preferences _Directory"), None, _("Open the Directory with Preferences Files"), dad.folder_cfg_open),
