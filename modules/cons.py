...
AVAILABLE_LANGS = ['default', 'cs', 'de', 'en', 'es', 'fr', 'hy', 'it', 'ja', 'lt', 'nl', 'pl', 'pt_BR', 'ru', 'tr', 'uk', 'zh_CN']
...
CHARS_LISTBUL = ["•", "◇", "▪", "-", "→", "⇒"]
CHARS_LISTNUM = [".", ")", "-", ">"]
NUM_CHARS_LISTBUL = len(CHARS_LISTBUL)
...
def get_entries(inst):
    ...
    ( "CutRow", "edit-cut", _("Cu_t Row"), "<shift><alt>X", _("Cut the Current Row/Selected Rows"), inst.text_row_cut),
    ( "CopyRow", "edit-copy", _("_Copy Row"), "<shift><alt>C", _("Copy the Current Row/Selected Rows"), inst.text_row_copy),
    ...
    ( "ColorForeground", "color_foreground", _("Text _Color Foreground"), "<shift><alt>F", _("Change the Color of the Selected Text Foreground"), inst.apply_tag_foreground),
    ( "ColorBackground", "color_background", _("Text C_olor Background"), "<shift><alt>B", _("Change the Color of the Selected Text Background"), inst.apply_tag_background),
    ...
    ( "BulletedList", "list_bulleted", _("Set/Unset _Bulleted List"), "<control><alt>1", _("Set/Unset the Current Paragraph/Selection as a Bulleted List"), inst.list_bulleted_handler),
    ( "NumberedList", "list_numbered", _("Set/Unset _Numbered List"), "<control><alt>2", _("Set/Unset the Current Paragraph/Selection as a Numbered List"), inst.list_numbered_handler),
    ( "ToDoList", "list_todo", _("Set/Unset _To-Do List"), "<control><alt>3", _("Set/Unset the Current Paragraph/Selection as a To-Do List"), inst.list_todo_handler),
    ...
    ( "NodeUp", "gtk-go-up", _("Node _Up"), "<shift>Up", _("Move the Selected Node Up"), inst.node_up),
    ( "NodeDown", "gtk-go-down", _("Node _Down"), "<shift>Down", _("Move the Selected Node Down"), inst.node_down),
    ( "NodeLeft", "gtk-go-back", _("Node _Left"), "<shift>Left", _("Move the Selected Node Left"), inst.node_left),
    ( "NodeNewFather", "gtk-jump-to", _("Node Change _Father"), "<shift>Right", _("Change the Selected Node's Father"), inst.node_change_father),
    ( "TreeSortAsc", "gtk-sort-ascending", _("Sort Tree _Ascending"), None, _("Sort the Tree Ascending"), inst.tree_sort_ascending),
    ( "TreeSortDesc", "gtk-sort-descending", _("Sort Tree _Descending"), None, _("Sort the Tree Descending"), inst.tree_sort_descending),
    ( "SiblSortAsc", "gtk-sort-ascending", _("Sort Siblings A_scending"), None, _("Sort all the Siblings of the Selected Node Ascending"), inst.node_siblings_sort_ascending),
    ( "SiblSortDesc", "gtk-sort-descending", _("Sort Siblings D_escending"), None, _("Sort all the Siblings of the Selected Node Descending"), inst.node_siblings_sort_descending),
    ...
    ( "NodeDel", "edit-delete", _("De_lete Node"), "Delete", _("Delete the Selected Node"), inst.node_delete),
    ...
    ( "FindInNode", "find", _("_Find in Node Content"), "<control>F", _("Find into the Selected Node Content"), inst.find_in_selected_node),
    ( "FindInNodes", "find", _("Find in _All Nodes Contents"), "<control><shift>F", _("Find into All the Tree Nodes Contents"), inst.find_in_all_nodes),
    ( "FindInSelNSub", "find", _("Find in _Selected Node and Subnodes Contents"), "<control><alt>F", _("Find into the Selected Node and Subnodes Contents"), inst.find_in_sel_node_and_subnodes),
    ( "FindNode", "find", _("Find in _Nodes Names and Tags"), "<control>T", _("Find in Nodes Names and Tags"), inst.find_a_node),
    ...
    ( "ReplaceInNode", "find_replace", _("_Replace in Node Content"), "<control>H", _("Replace into the Selected Node Content"), inst.replace_in_selected_node),
    ( "ReplaceInNodes", "find_replace", _("Replace in _All Nodes Contents"), "<control><shift>H", _("Replace into All the Tree Nodes Contents"), inst.replace_in_all_nodes),
    ( "ReplaceInSelNSub", "find_replace", _("Replace in _Selected Node and Subnodes Contents"), "<control><alt>H", _("Replace into the Selected Node and Subnodes Contents"), inst.replace_in_sel_node_and_subnodes),
...
def get_popup_menu_tree(inst):
    ...
    ("pin-add", _("Add to _Bookmarks"), "<control><shift>B", _("Add the Current Node to the Bookmarks List"), inst.bookmark_curr_node),
    ("pin-remove", _("_Remove from Bookmarks"), "<control><alt>B", _("Remove the Current Node from the Bookmarks List"), inst.bookmark_curr_node_remove),
...
def get_popup_menu_entries_text(inst):
    ...
    ("edit-cut", _("Cu_t Row"), "<shift><alt>X", _("Cut the Current Row/Selected Rows"), inst.text_row_cut),
    ("edit-copy", _("C_opy Row"), "<shift><alt>C", _("Copy the Current Row/Selected Rows"), inst.text_row_copy),
