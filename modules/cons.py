...
def get_entries(inst):
    ...
    ( "CTDStorage", "gtk-harddisk", _("_Data Storage Type/Protection"), None, _("Edit Data Storage Type and Protection for the Current Document"), inst.dialog_edit_data_storage),
