...
def get_entries(inst):
    ...
    ( "CutRow", "edit-cut", _("Cu_t Row"), "<alt><shift>X", _("Cut the Current Row/Selected Rows"), inst.text_row_cut),
    ( "CopyRow", "edit-copy", _("_Copy Row"), "<alt><shift>C", _("Copy the Current Row/Selected Rows"), inst.text_row_copy),
...
def get_popup_menu_entries_text(inst):
    ...
    ("edit-cut", _("Cu_t Row"), "<alt><shift>X", _("Cut the Current Row/Selected Rows"), inst.text_row_cut),
    ("edit-copy", _("C_opy Row"), "<alt><shift>C", _("Copy the Current Row/Selected Rows"), inst.text_row_copy),
