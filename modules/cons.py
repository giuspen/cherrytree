...
def get_entries(inst):
   ...
   ( "NodeChangeFather", "gtk-jump-to", _("Node Change _Father"), "<shift>Right", _("Change the Selected Node's Father"), inst.node_change_father),
...
def get_popup_menu_tree(inst):
   ...
   ("separator", None, None, None, None),
   ("gtk-clear", _("De_lete Node"), "<shift>Delete", _("Delete the Selected Node"), inst.node_delete),
   ("separator", None, None, None, None),
