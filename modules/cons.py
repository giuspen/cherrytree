...
ICONS_FILENAMES = [
   (GLADE_PATH + 'image_insert.png', 'Insert Image'), (GLADE_PATH + 'image_edit.png', 'Edit Image'),
   (GLADE_PATH + 'image_save.png', 'Save Image'),
   (GLADE_PATH + 'table_insert.png', 'Insert Table'), (GLADE_PATH + 'table_edit.png', 'Edit Table'),
   (GLADE_PATH + 'table_save.png', 'Save Table'),
   (GLADE_PATH + 'codebox_insert.png', 'Insert CodeBox'), (GLADE_PATH + 'codebox_edit.png', 'Edit CodeBox'),
   (GLADE_PATH + 'anchor_insert.png', 'Insert Anchor'), (GLADE_PATH + 'anchor_edit.png', 'Edit Anchor'),
   (GLADE_PATH + 'anchor.png', 'Anchor'), (GLADE_PATH + 'insert.png', 'Insert'),
   (GLADE_PATH + 'link_handle.png', 'Handle Link'), (GLADE_PATH + 'link_website.png', 'WebSite Link'),
   (GLADE_PATH + 'cherry_edit.png', 'Edit Node'),
   (GLADE_PATH + 'list_bulleted.png', 'Bulleted List'), (GLADE_PATH + 'list_numbered.png', 'Numbered List'),
   (GLADE_PATH + 'node_name_header.png', 'Node Name Header'), (GLADE_PATH + 'find.png', 'Find'),
   (GLADE_PATH + 'find_again.png', 'Find Again'), (GLADE_PATH + 'find_back.png', 'Find Back'),
   (GLADE_PATH + 'find_replace.png', 'Find Replace'), (GLADE_PATH + 'color_background.png', 'Change Color Background'),
   (GLADE_PATH + 'color_foreground.png', 'Change Color Foreground'), (GLADE_PATH + 'format-text-large.png', 'Format Text Large'),
   (GLADE_PATH + 'format-text-large2.png', 'Format Text Large2'), (GLADE_PATH + 'format-text-small.png', 'Format Text Small'),
   (GLADE_PATH + 'format_text_latest.png', 'Format Text Latest'), (GLADE_PATH + 'format_text.png', 'Format Text'),
   (GLADE_PATH + 'object-rotate-left.png', 'Rotate Left'), (GLADE_PATH + 'object-rotate-right.png', 'Rotate Right'),
   (GLADE_PATH + 'node_bullet.png', 'Node Bullet'), (GLADE_PATH + 'node_no_icon.png', 'Node NoIcon'),
   (GLADE_PATH + 'cherry_black.png', 'Black Cherry'),
   (GLADE_PATH + 'cherry_blue.png', 'Blue Cherry'), (GLADE_PATH + 'cherry_cyan.png', 'Cyan Cherry'),
   (GLADE_PATH + 'cherry_green.png', 'Green Cherry'), (GLADE_PATH + 'cherry_grey.png', 'Grey Cherry'),
   (GLADE_PATH + 'cherry_orange.png', 'Orange Cherry'), (GLADE_PATH + 'cherry_orange_dark.png', 'Orange Dark Cherry'),
   (GLADE_PATH + 'cherry_purple.png', 'Purple Cherry'), (GLADE_PATH + 'cherry_red.png', 'Red Cherry'),
   (GLADE_PATH + 'cherry_sherbert.png', 'Sherbert Cherry'), (GLADE_PATH + 'cherry_yellow.png', 'Yellow Cherry'),
   (GLADE_PATH + 'to_html.png', 'To HTML'), (GLADE_PATH + 'import_in_cherrytree.png', 'Import in CherryTree'),
   (GLADE_PATH + 'cherrytree.png', 'CherryTree'),
   (GLADE_PATH + 'quit-app.png', 'Quit App'), (GLADE_PATH + 'new-instance.png', 'New Instance'),
   (GLADE_PATH + 'toolbar.png', 'Toolbar'), (GLADE_PATH + 'cherries.png', 'Tree'),
   (GLADE_PATH + 'help-contents.png', 'Help Contents'), (GLADE_PATH + 'horizontal_rule.png', 'Horizontal Rule') ]
...
def get_entries(inst):
   ...
   ( "OpenFile", "gtk-open", _("_Open File"), "<control>O", _("Open a .ctd File"), inst.file_open),
   ...
   ( "SelNode2CTD", "Import in CherryTree", _("_Export Node and Subnodes"), None, _("Export the Selected Node and its Subnodes"), inst.node_and_subnodes_export),
   ...
   ( "InsertTOC", "Handle Link", _("Insert T_OC"), None, _("Insert Table of Contents"), inst.toc_insert),
   ...
   ( "FindNode", "Find", _("Find a _Node"), None, _("Find a Node from its Name"), inst.find_a_node),
   ...
   ( "FromBasket", "Import in CherryTree", _("From _Basket Folder"), None, _("Add Nodes of a Basket Folder to the Current Tree"), inst.nodes_add_from_basket_folder),
   ( "FromCherryTree", "Import in CherryTree", _("From _CherryTree File"), None, _("Add Nodes of a CherryTree File to the Current Tree"), inst.nodes_add_from_cherrytree_file),
   ...
   ( "ChangeNodeProp", "Edit Node", _("Change Node _Properties"), "F2", _("Edit the Properties of the Selected Node"), inst.node_modify),
...
def get_popup_menu_entries_text(inst):
   ...
   ("Handle Link", _("Insert T_OC"), _("Insert Table of Contents"), inst.toc_insert),
