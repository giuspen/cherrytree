...
def get_popup_menu_entries_text(inst):
   ...
   ("submenu-start", _("_Justify") , "gtk-justify-center", None),
   ("gtk-justify-left", _("Justify _Left"), _("Justify Left the Current Paragraph"), inst.apply_tag_justify_left),
   ("gtk-justify-center", _("Justify _Center"), _("Justify Center the Current Paragraph"), inst.apply_tag_justify_center),
   ("gtk-justify-right", _("Justify _Right"), _("Justify Right the Current Paragraph"), inst.apply_tag_justify_right),
   ("submenu-end", None, None, None),
   ("separator", None, None, None),
