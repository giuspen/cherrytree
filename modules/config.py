...
def preferences_tab_text_n_code(dad, vbox_all_nodes, pref_dialog):
    ...
    align_text_editor = Gtk.Alignment.new()
    ...
    hbox_reset.pack_start(Gtk.Label(), True, True, 0)
    vbox_special_chars.pack_start(Gtk.Label(), TFalse, True, 0)
    ...
    align_misc_all = Gtk.Alignment.new()
...
def preferences_tab_rich_text(dad, vbox_text_nodes, pref_dialog):
    ...
    align_spell_check = Gtk.Alignment.new()
    ...
    align_rt_theme = Gtk.Alignment.new()
    ...
    align_misc_text = Gtk.Alignment.new()
...
def preferences_tab_text(dad, vbox_text, pref_dialog):
    ...
    align_editor = Gtk.Alignment.new()
...
def preferences_tab_plain_text_n_code(dad, vbox_code_nodes, pref_dialog):
    ...
    align_syntax = Gtk.Alignment.new()
    ...
    align_codexec = Gtk.Alignment.new()
...
def preferences_tab_tree_2(dad, vbox_tree, pref_dialog):
    ...
    align_misc_tree = Gtk.Alignment.new()
...
def preferences_tab_tree_1(dad, vbox_tree, pref_dialog):
    ...
    align_tt_theme = Gtk.Alignment.new()
    ...
    align_nodes_icons = Gtk.Alignment.new()
    ...
    align_nodes_startup = Gtk.Alignment.new()
...
def preferences_tab_links(dad, vbox_links, pref_dialog):
    ...
    align_links_actions = Gtk.Alignment.new()
    ...
    align_links_colors = Gtk.Alignment.new()
    ...
    align_links_misc = Gtk.Alignment.new()
...
def preferences_tab_misc(dad, vbox_misc, pref_dialog):
    ...
    align_system_tray = Gtk.Alignment.new()
    ...
    align_saving = Gtk.Alignment.new()
    ...
    align_misc_misc = Gtk.Alignment.new()
    ...
    align_language = Gtk.Alignment.new()
