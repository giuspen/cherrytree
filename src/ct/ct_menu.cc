...
void CtMenu::init_actions(CtActions* pActions)
{
   ...
   _actions.push_back(CtMenuAction{ "", "ImportMenu", CtConst::STR_STOCK_CT_IMP, _("_Import"), None, None, sigc::signal<void>() });
   _actions.push_back(CtMenuAction{ "", "ExportMenu", "ct_export_from_cherrytree", _("E_xport"), None, None, sigc::signal<void>() });
   ...
   _actions.push_back(CtMenuAction{ tree_cat, "tree_node_del", "ct_edit_delete", _("De_lete Node"), KB_CONTROL + "Delete", _("Delete the Selected Node"), sigc::mem_fun(*pActions, &CtActions::node_delete) });
...
<menubar name='MenuBar'>
  ...
  <menu action='FormattingMenu'>
    ...
    <separator/>
    <menu _name='_Font' image='ct_fonts'>
    ...
    <menu _name='_Toggle' image='ct_fmt-txt-large'>
  ...
  <menu action='SearchMenu'>
    <menu _name='_Find' image='ct_find'>
...
_("_Toggle"), _("_Font"), _("_Find"), _("_Replace")
#endif
...
<popup>
  ...
  <separator/>
  <menu _name='_Paste' image='ct_insert'>
    <menuitem action='handle_image'/>
    <menuitem action='handle_table'/>
    <menuitem action='handle_codebox'/>
    <menuitem action='handle_embfile'/>
...
#if 0
// the following is to have xgettext add <menu _name='THIS_STRING' to the strings to be translated
_("For_matting"), _("_List"), _("_Justify"), _("_Paste"), _("C_hange Case"), _("_Row"), _("_Find"), _("_Replace")
#endif
...
#if 0
// the following is to have xgettext add <menu _name='THIS_STRING' to the strings to be translated
_("_Paste"), _("C_hange Case"), _("_Row"), _("_Find"), _("_Replace")
#endif
