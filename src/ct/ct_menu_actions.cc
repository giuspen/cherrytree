...
void CtMenu::init_actions(CtActions* pActions)
{
    ...
    _actions.push_back(CtMenuAction{tree_cat, "tree_dup_node_subnodes", "ct_tree-nodesub-dupl", _("_Duplicate Node and Sub Nodes"), None,
        _("Duplicate the Selected Node With SubNodes"), sigc::mem_fun(*pActions, &CtActions::node_subnodes_duplicate)});
    ...
    _actions.push_back(CtMenuAction{table_cat, "table_column_decrease_width", "ct_go-back",
        _("Decrease Column Width"), KB_CONTROL+KB_ALT+"period",
    ...
    _actions.push_back(CtMenuAction{codebox_cat, "codebox_increase_width", "ct_go-forward",
        _("Increase CodeBox Width"), KB_CONTROL+"period",
    ...
    _actions.push_back(CtMenuAction{codebox_cat, "codebox_decrease_width", "ct_go-back",
        _("Decrease CodeBox Width"), KB_CONTROL+KB_ALT+"period",
