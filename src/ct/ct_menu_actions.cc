...
void CtMenu::init_actions(CtActions* pActions)
{
    ...
    _actions.push_back(CtMenuAction{tools_cat, "select_node", "ct_execute", _("_Select Node..."), KB_CONTROL+KB_SHIFT+"g",
    ...
    _actions.push_back(CtMenuAction{tree_cat, "node_unbookmark", "ct_pin-remove", _("_Remove from Bookmarks"), KB_SHIFT+KB_ALT+"k",
