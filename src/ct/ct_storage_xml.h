...
public:
    ...
    xmlpp::Element* node_to_xml(const CtTreeIter* ct_tree_iter,
                                ...
                                const int start_offset = 0,
                                const int end_offset = -1);
    Gtk::TreeModel::iterator node_from_xml(CT_XML_CONST xmlpp::Element* xml_element,
    ...
    Glib::RefPtr<Gtk::TextBuffer> create_buffer_and_widgets_from_xml(CT_XML_CONST xmlpp::Element* parent_xml_element,
